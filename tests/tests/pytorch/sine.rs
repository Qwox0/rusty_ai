...
fn sine() {
    ...
    let ai = NeuralNetworkBuilder::default()
        ...
        .input::<1>()
        .layer(w1.get_height(), Initializer::Initialized(w1), Initializer::Initialized(b1))
        .layer(w2.get_height(), Initializer::Initialized(w2), Initializer::Initialized(b2))
        .layer(w3.get_height(), Initializer::Initialized(w3), Initializer::Initialized(b3))
        .layer(w4.get_height(), Initializer::Initialized(w4), Initializer::Initialized(b4))
        .layer(w5.get_height(), Initializer::Initialized(w5), Initializer::Initialized(b5))
