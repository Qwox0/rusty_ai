...
where F: Fn(usize) -> bool {
    ...
    let test = |epoch: usize, ai: &TrainableNeuralNetwork<1, 1>, expected_loss: f64| {
        ...
        // println!("epoch: {:>4}, loss: {:<20} {:064b}", epoch, res.error,
        // res.error.to_bits()); println!("    expected_loss: {:<20} {:064b}",
        // expected_loss, expected_loss.to_bits()); println!("{}diff:
        // {:064b}\n", " ".repeat(34), res.error.to_bits() ^ expected_loss.to_bits());
...
fn sine_simple2() {
    ...
    let b5 = LayerBias::from([-0.1936956647543538].to_vec());
    let x = [[-0.22222222222222232]];
    let y = [[-0.22039774345612237]];
    let epochs = 1;
    let test_spread = 1;
    let losses = [0.045811850072791226, 0.04310963328560205];
...
fn pytorch_sine2() {
    ...
    let b5 = LayerBias::from([-0.1936956647543538]);
    let x = [
        [-2.0],
        [-1.5555555555555556],
        [-1.1111111111111112],
    ...
    let losses = [
        6.091501566998737,
        0.2022321139593204,
        0.027460098795096925,
        0.021330997034744677,
        0.026299384662278453,
        0.032442918815177704,
        0.01232583981672623,
        0.09323503035433732,
        0.064512409294035,
        0.08804533655466171,
    ...
    test(Args {
        ...
        losses: &losses,
        epochs: 1000,
        test_condition: |epoch| epoch % 100 == 0,
    });
