...
use std::{cmp::Ordering, iter::once, ops::Range, path::PathBuf, time::Instant};
...
pub mod tests {
    ...
    fn setup_nn() -> NNTrainer<IMAGE_SIZE, OUTPUTS, SquaredError, SGD_> {
        NNBuilder::default()
            .input::<IMAGE_SIZE>()
            .layer(128, Initializer::PytorchDefault, Initializer::PytorchDefault)
            .activation_function(ActivationFn::ReLU)
            ...
            .optimizer(SGD { learning_rate: 0.003, ..SGD::default() })
